...
public class MatchingWriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    NetworkManager.getInstance().postStoryWrite(MatchingWriteActivity.this, "title", writeContents.getText().toString(), 1, 3, file, new NetworkManager.OnResultListener<StoryWriteResult>() {
                        @Override
                        public void onSuccess(Request request, StoryWriteResult result) {
                            Toast.makeText(MatchingWriteActivity.this, result.success.message, Toast.LENGTH_LONG).show();
                        ...
                        public void onFailure(Request request, int code, Throwable cause) {
                            Toast.makeText(MatchingWriteActivity.this,cause.getMessage().toString(),Toast.LENGTH_SHORT).show();
