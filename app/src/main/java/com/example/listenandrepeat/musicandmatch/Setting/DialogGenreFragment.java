...
public class DialogGenreFragment extends DialogFragment {
    ...
    OnGenreSelectionListener mSelectedListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSelectedListener != null) {
                    mSelectedListener.onGenreSelected(0);
                }
                dismiss();
            }
        });
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSelectedListener != null) {
                    mSelectedListener.onGenreSelected(1);
                }
                dismiss();
            }
        });
        ...
        imageView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSelectedListener != null) {
                    mSelectedListener.onGenreSelected(2);
                }
                dismiss();
            }
        });
        ...
        imageView4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSelectedListener != null) {
                    mSelectedListener.onGenreSelected(3);
                }
                dismiss();
            }
        });
        ...
        imageView5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSelectedListener != null) {
                    mSelectedListener.onGenreSelected(4);
                }
                dismiss();
            }
        });
        ...
        imageView6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSelectedListener != null) {
                    mSelectedListener.onGenreSelected(5);
                }
                dismiss();
            }
        });
        ...
        imageView7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSelectedListener != null) {
                    mSelectedListener.onGenreSelected(6);
                }
                dismiss();
            }
        });
        ...
        imageView8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSelectedListener != null) {
                    mSelectedListener.onGenreSelected(7);
                }
                dismiss();
            }
        });
